...
function registrar() {
    ...
    const tipoPersonaVal = document.getElementById("tipoPersona").value;
    ...
    if (!tipoPersonaVal) {
        mostrarMensaje("Debés seleccionar un tipo de persona.", "error");
        return;
    }
    ...
    const datos = {
        ...
        nombreUsuario,
        clave,
        idTipoPersona: parseInt(tipoPersonaVal),  // valor elegido por el usuario
        idPerfil: 2         // 2 = Usuario en PERFIL
    };
